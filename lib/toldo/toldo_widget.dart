            ...
            children: [
              Column(
                ...
                children: [
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            ...
                            child: Stack(
                              children: [
                                // Container da Deteção de Chuva (Modificado)
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    // Apenas o conteúdo deste container foi trocado
                                    child: Align(
                                ...
                                // Container do Controle Manual (com modificação interna)
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: Stack(
                                      children: [
                                        // Texto de Controle Manual (Modificado)
                                        Align(
                                          alignment: AlignmentDirectional(-1.0, -1.0),
                                          child: Padding(
                                            padding: EdgeInsetsDirectional.fromSTEB(20.0, 25.0, 0.0, 0.0),
                                            // O Text foi substituído por RichText
                                            child: RichText(
                                              text: TextSpan(
                                                children: [
                                                  TextSpan(
                  ...
                  // Card do Modo Automático (Original)
                  Padding(
